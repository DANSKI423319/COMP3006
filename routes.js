...
async function insertComputer(req, res) {
    ...
    db.createComputer(req.body.addName, req.body.addStatus, req.body.addNotes, req.body.addRoom);
...
async function updateComputer(req, res) {
    ...
    db.updateComputerByID(req.body.searchId, req.body.updateName, req.body.updateStatus, req.body.updateNotes, req.body.updateRoom);
